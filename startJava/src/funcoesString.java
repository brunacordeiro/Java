/*
		 ...
		 * 
		 * IndexOf - informa a posição da primeira ocorrencia de um valor na string
		 * LastIndexOf - informa a posição da ultima ocorrencia de um string
		 * 
...
public class funcoesString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Maiúscula: " + '-' + original.toUpperCase() + '-');

		System.out.println("Removendo espaços inicio e fim: " + '-' + original.trim() + '-');
